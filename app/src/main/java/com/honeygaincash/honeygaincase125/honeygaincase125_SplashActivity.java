...
public class honeygaincase125_SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.honeygaincase125_splash);
    ...
    private void NextScreen() {
        ...
        hndler.postDelayed(new Runnable() {
            @Override
            public void run() {
                honeygaincase125_SplashActivity.this.startActivity(new Intent(honeygaincase125_SplashActivity.this, honeygaincase125_start_page.class));
            }
        }, 8000);
    ...
    void datafromlink() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String dataUrl = "https://adstxt.dev/7b03984d39/ads.txt";
